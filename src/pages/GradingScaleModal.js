...
const GradingScaleModal = ({ open, children, onClose }) => {
    ...
    return ReactDOM.createPortal( 
        <div className="fixed inset-0 z-50 flex h-full w-full items-center justify-center bg-black/[.54]">
            <div className="flex flex-col items-center justify-center h-2/4 w-2/3 rounded-lg bg-blue-400 p-5">
                ...
                <button className="bg-green-400 py-1 px-5 rounded-lg font-bold" onClick={onClose}>CLOSE</button>
            </div>
        </div>,
